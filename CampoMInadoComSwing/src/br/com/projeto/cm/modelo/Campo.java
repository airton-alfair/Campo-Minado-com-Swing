...
public class Campo {
    ...
    private void notificarObservadores(CampoEvento evento){ // sempre que o evento acontecer esse metodo sera chamado
        observadores.stream()
    ...
    void alternarMarcacao(){
        if(!aberto){
            ...
            if(marcado) {
                notificarObservadores(CampoEvento.MARCAR); // para chamar o metodo
            }else{
    ...
    void setAberto(boolean aberto){
        ...
        if(aberto){
            notificarObservadores(CampoEvento.ABRIR); // Notificando Observadores
        }
    }
